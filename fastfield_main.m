function [Efield,xg,yg,zg,elfv,trans_mat]= fastfield_main(standard_efield,grid_vec,electrode,electrode_patient,perc,amp,side)
...
if sum(perc)==100 || sum(perc)==0
    ...
    [Efield] = get_efield(perc,standard_efield,amp);
