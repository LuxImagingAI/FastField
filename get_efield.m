...
if strcmp(Electrode_type,'medtronic_3389') ...
        || strcmp(Electrode_type,'medtronic_3387')...
        || strcmp(Electrode_type,'medtronic_3391')...
        || strcmp(Electrode_type,'stjude_activetip_2mm')...
        || strcmp(Electrode_type,'stjude_activetip_3mm')
...
elseif strcmp(Electrode_type,'boston_vercise_directed') ....
        || strcmp(Electrode_type,'boston_vercise') ...
        || strcmp(Electrode_type,'stjude_directed_short') ....
        || strcmp(Electrode_type,'stjude_directed_long')
eeg=((perc(1)*standard_efield{1,1})+(perc(2)*standard_efield{2,1})+...
(perc(3)*standard_efield{3,1})+(perc(4)*standard_efield{4,1})+...
